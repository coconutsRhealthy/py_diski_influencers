...
def run_java_class() -> str:
    print("🚀 Start running Java class InstaAccountFinder...")
    ...
    java_class = "com.lennart.model.InstaAccountFinder"
...
def save_output_to_file(output_text: str):
    ...
    print("💾 Opslaan van output naar instagram_user_urls.txt...")

    input_file = Path("../apify_input/instagram_user_urls.txt")
